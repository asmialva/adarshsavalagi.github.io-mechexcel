    ...
    <>
      ...
      <div className="flex mx-auto w-11/12  flex-col md:flex-row my-6">
        <div className="md:w-1/4  p-5">
          ...
          <button onClick={() => setState(0)} className="btn m-2 w-full bg-white   text-left flex justify-start border-solid"> <span className='text-xl'>{state == 0 ? '\u2022' : ''}</span>  CATALYST HANDLING SOLUTIONS</button>
          <button onClick={() => setState(1)} className="btn m-2 w-full bg-white   text-left flex justify-start border-solid uppercase"> <span className='text-xl'>{state == 1 ? '\u2022' : ''}</span>Integrated Mechanical Solutions</button>
        ...
        {state == 1 ? <div className="md:w-3/4 m-3">
          ...
          : <div className="md:w-3/4 m-3" >
            ...
            <p className='my-1 font-medium'>Cost control is important and MECHEXCEL will deliver the most effective cost solution to catalyst handling projects. We achieve this through:</p>
            ...
            <p className='my-1 font-medium'>MECHEXCEL material handling equipment can collect, transport, and transfer reactor catalyst from the dump nozzle to any size container requested. Our external dust collectors recover air born particulate created during the material transfer phase of collection.</p>
            <p className='my-1 font-medium'>In areas where access is difficult or for unloading horizontal dump nozzles we have enclosed conveyors and screw conveyors that can assist with the removal of catalyst from the most difficult of locations.</p>
            <h2 className='font-semibold my-2 text-xl'>Vacuum Method</h2>
            <p className='my-1 font-medium'>Catalyst unloading is typically accomplished by vacuuming from the entry manway, dumping from the unloading nozzle or flange at the base of the reactor, or a combination of both. Unloading using the vacuum method is normally required under the following circumstances: removal of top support and upper zone catalyst only, known as a reactor skim:</p>
            ...
            <p className='my-1 font-medium'>MECHEXCEL has the ability to package catalyst in any way the client wants. MECHEXCEL has partnerships with Packgen as an alternative to steel bins and Flow bins, when steel bins are required. MECHEXCEL can incorporate the supply of drums, bags and steel bins into project costing.</p>
            <h2 className='font-semibold my-2 text-xl'>Catalyst Blending and Storage</h2>
            <p className='my-1 font-medium'>Catalyst blending and storage capabilities are located in warehouses in Houston Texas. We offer a variety of catalyst blending options. MECHEXCEL can also offer storage facilities in other locations, please contact us if you require catalyst storage and logistical support, or to discuss other options that meet your unique needs.</p>




            <h2 className='font-bold my-2 text-2xl'>3. Catalyst Loading</h2>
            <p className='my-1 font-medium'>By utilizing a specially-trained workforce and purpose-built equipment, Catalyst handling Resources can execute catalyst projects efficiently and safely, with minimal catalyst attrition and dust elimination control systems. <br />
            ...
            <p className='my-1 font-medium'>MECHEXCEL utilizes Unidense™ technology for the loading of primary reformers. This technology allows consistent loading of catalyst into each tube, ensuring that all pressure drops (dP) are within the pre-determined range. Both Unidense™ and Uniloading™ services are available. <br />
            ...
            <p className='my-1 font-medium'>MECHEXCEL combines purpose-built equipment and highly-skilled, fully-utilized teams. This allows us to deliver a wide range of services, from project planning and estimating, through safety and quality planning, and ultimately the execution of the work, ensuring a rapid turnaround with minimum downtime for our clients.</p>
            <h2 className='font-semibold my-2 text-xl'>Planning and Management</h2>
            <p className='my-1 font-medium'>MECHEXCEL has the ability to put our experts on site months in advance of a shutdown; planning, organizing, and managing our people and subcontractors from start to finish.</p>
            <p className='my-1 font-medium'>Combining our holistic approach to managing shutdowns with our multi-skilled workforce means we are able to provide a ‘blind to blind’ service; completing the entire project from planning, through to the final stages before the plant is reactivated.</p>
            <p className='my-1 font-medium'>By providing or managing all parties, MECHEXCEL operates rapidly, adapts to changing circumstances and requirements faster, and still be one of the safest companies in the industry today.</p>
            <h2 className='font-semibold my-2 text-xl'>Cost Effectiveness</h2>
            <p className='my-1 font-medium'>MECHEXCEL can become involved at any stage from planning though execution of a turnaround.  Our unrivalled ability to offer a ‘blind to blind’ service means that we provide input at every stage of the turnaround, ultimately helping our client to diminish cost, time, and organizational barriers.</p>
            <p className='my-1 font-medium'>We work closely with the client from beginning to end, placing a keen focus on the debrieﬁng stage of a turnaround, and identifying further improvements, cost savings, and best practices.</p>
